...
<head>
	...
	<!-- Load CSS Compiled-->
	<link href="https://fonts.googleapis.com/css?family=Fira+Sans:100,300,400,500,600,700,800,900&display=swap&subset=cyrillic" rel="stylesheet">
...
<body>
	...
	<header class="header" id="header">
		...
		<div class="header__aside">
			...
			<a class="logo" href="#"><p>Go<span></span>surf</p></a>
			...
			<nav class="menu">
				<ul class="menu__list">
					...
					<li class="menu__item">
						...
						<img class="menu__icon" src="img/svg/menu-icon1.svg" alt="Menu icon">
						<span class="menu__title">Surf</span>
						</a>
					</li>

					<li class="menu__item">
						<a href="#" class="menu__link">
						<img class="menu__icon" src="img/svg/menu-icon2.svg" alt="Menu icon">
						<span class="menu__title">Travel</span>
						</a>
					</li>

					<li class="menu__item">
						<a href="#" class="menu__link">
						<img class="menu__icon" src="img/svg/menu-icon3.svg" alt="Menu icon">
						<span class="menu__title">Sleep</span>
						</a>
						</li>

					<li class="menu__item">
						<a href="#" class="menu__link">
						<img class="menu__icon" src="img/svg/menu-icon4.svg" alt="Menu icon">
			...
			<a class="menu-link" href="#" onclick="return false"><span></span></a>
		</div>

		<div class="header__arrows-down">
			<a href="#" class="animated fadeInDown infinite slow">
				<img src="img/svg/down-arrows.svg" alt="Arrows down">
			</a>
		</div>

		<div class="header__map">
			<svg width="1001" height="350" viewBox="0 0 1001 496" fill="none" xmlns="http://www.w3.org/2000/svg">
			<g opacity="0.29827">
		...
		<div class="header__slider">
			...
			<div class="header__slider-item slider-item">
				<div class="slider-item__info animated fadeInRight delay-1s slow">
					...
					<a href="#" class="slider-item__info-link">
						<img src="img/svg/arrows-right.svg" alt="Arrow Right">
					</a>
				</div>
			</div>
		...
		<div class="slider-dotshead animated fadeInUp delay-1s">
			...
			<div class="slider-dotshead__item">
				<div class="dots-box">
...
<div class="container">
	...
	<section class="surf section-padding" id="surf">
		<div class="surf__coordinates wow fadeIn" data-wow-offset="400" data-wow-duration="3s" data-wow-delay="1s">
			34.0501 N -118.2446 W
		</div>
		<div class="title">
			<div class="title__block">
				<span class="wow fadeIn" data-wow-offset="250" data-wow-delay="1s">surf</span>
				<h3 class="wow fadeInLeft" data-wow-offset="250">surf</h3>
			</div>
		</div>
		<div class="surf__subtitle">
			<div class="subtitle wow fadeInRight" data-wow-offset="250">
				<div class="headline-left">
					Current location
				</div>
				<div class="subtitle__head">
					California <span>|</span> USA
				</div>
				<div class="subtitle__surf-bg">
					<img src="img/surf-bg.png" alt="Surf bg">
				</div>
			</div>
		</div>

		<div class="slider-map wow zoomIn" data-wow-offset="200" data-wow-duration="1.5s" data-wow-duration="1.5s">
			<div class="slider-dots slider-dots--1 wow fadeIn" data-wow-delay="1s" data-wow-duration="1.5s">
				...
				<div class="slider-dots__content">
					...
					<div class="slider-dots__content-row">
						<div class="slider-dots__content-head">
							<div class="slider-dots__content-title">Malibu Beach</div>
							<div class="slider-dots__content-subtitle">USA</div>
						</div>
			...
			<div class="slider-dots slider-dots--2 wow fadeIn" data-wow-delay="1.1s" data-wow-duration="1.5s">
				<div class="slider-dots__circle"></div>
				<div class="slider-dots__content">
			...
			<div class="slider-dots slider-dots--3 wow fadeIn" data-wow-delay="1.2s" data-wow-duration="1.5s">
				<div class="slider-dots__circle"></div>
				<div class="slider-dots__content">

					<div class="slider-dots__content-row">
						<div class="slider-dots__content-head">
							<div class="slider-dots__content-title">Cloud nine</div>
							<div class="slider-dots__content-subtitle">Philippines</div>
						</div>
						<a href="#" class="slider-dots__content-link">
							<img src="img/svg/arrows-right.svg" alt="Arrow right">
						</a>
			...
			<div class="slider-dots slider-dots--4 wow fadeIn" data-wow-delay="1.3s" data-wow-duration="1.5s">
				<div class="slider-dots__circle"></div>
				<div class="slider-dots__content">

					<div class="slider-dots__content-row">
						<div class="slider-dots__content-head">
							<div class="slider-dots__content-title">Vieux</div>
							<div class="slider-dots__content-subtitle">Boucau</div>
						</div>
						<a href="#" class="slider-dots__content-link">
							<img src="img/svg/arrows-right.svg" alt="Arrow right">
						</a>
			...
			<div class="slider-dots slider-dots--5 wow fadeIn" data-wow-delay="1.4s" data-wow-duration="1.5s">
				<div class="slider-dots__circle"></div>
				<div class="slider-dots__content">
			...
			<div class="slider-dots slider-dots--6 wow fadeIn" data-wow-delay="1.5s" data-wow-duration="1.5s">
				<div class="slider-dots__circle"></div>
				<div class="slider-dots__content">
			...
			<div class="slider-dots slider-dots--7 wow fadeIn" data-wow-delay="1.6s" data-wow-duration="1.5s">
				<div class="slider-dots__circle"></div>
				<div class="slider-dots__content">
			...
			<div class="slider-dots slider-dots--8 wow fadeIn" data-wow-delay="1.7s" data-wow-duration="1.5s">
				<div class="slider-dots__circle"></div>
				<div class="slider-dots__content">
		...
		<div class="surf-slider">
			<div class="surf-box wow fadeInUp" data-wow-offset="250" data-wow-delay="0.3s" style="background-image: url(img/slide-1.jpg);">
			...
			<div class="surf-box wow fadeInUp" data-wow-offset="250" data-wow-delay="0.5s" style="background-image: url(img/slide-2.jpg);">
				<div class="surf-box__inner">
			...
			<div class="surf-box wow fadeInUp" data-wow-offset="250" data-wow-delay="0.7s" style="background-image: url(img/slide-3.jpg);">
				<div class="surf-box__inner">
			...
			<div class="surf-box wow fadeInUp" data-wow-offset="250" data-wow-delay="0.9s" style="background-image: url(img/slide-4.jpg);">
				<div class="surf-box__inner">
			...
			<div class="surf-box" style="background-image: url(img/slide-1.jpg);">
				<div class="surf-box__inner">
					<div class="surf-box__inner-title">Malibu Beach</div>
					<div class="surf-box__inner-location">California <span>|</span> USA</div>
					<div class="surf-box__inner-btn">
			...
			<div class="surf-box" style="background-image: url(img/slide-2.jpg);">
				<div class="surf-box__inner">
					<div class="surf-box__inner-title">Airlie Beach</div>
					<div class="surf-box__inner-location">Queensland <span>|</span> Australia</div>
					<div class="surf-box__inner-btn">
			...
			<div class="surf-box" style="background-image: url(img/slide-3.jpg);">
				<div class="surf-box__inner">
					<div class="surf-box__inner-title">Cloud Nine</div>
					<div class="surf-box__inner-location">Siargao <span>|</span> Philippines</div>
					<div class="surf-box__inner-btn">
			...
			<div class="surf-box wow fadeInUp" data-wow-offset="250" data-wow-delay="1.2s" style="background-image: url(img/slide-4.jpg);">
				<div class="surf-box__inner">
					<div class="surf-box__inner-title">Vieux Boucau</div>
					<div class="surf-box__inner-location">Hossegor <span>|</span> France</div>
					<div class="surf-box__inner-btn">
	...
	<section class="holder travel section-padding" id="travel">
		<div class="title wow fadeInLeft" data-wow-offset="250">
			<div class="title__block">
				<span class="wow fadeIn" data-wow-offset="250" data-wow-delay="1s">travel</span>
				<h3 class="wow fadeInLeft" data-wow-offset="250">travel</h3>
			</div>
		</div>

		<div class="holder-slider">

			<div class="holder-slider__item">
				...
				<div class="holder-slider__bg" style="background-image: url(img/travel-slider-bg.png);"></div>

				<div class="holder-slider__info">
					<div class="holder-slider__info-airline wow fadeInRight" data-wow-offset="400" data-wow-duration="2s" style="background-image: url(img/airline.png);">
						<div class="subtitle">
							...
							<div class="subtitle__head">
								Virgin Australia
								<img class="logo-airline" src="img/svg/virgin-airline.svg" alt="Virgin">
							</div>
						</div>
					</div>
					<div class="holder-slider__description">
						<div class="holder-slider__description-item wow fadeInUp" data-wow-offset="250" data-wow-delay="0.8s">
							<div class="holder-slider__description-subtitle">Destination</div>
							<div class="holder-slider__description-title">Queensland<br>Australia</div>
						</div>
						<div class="holder-slider__description-item wow fadeInUp" data-wow-offset="250" data-wow-delay="0.6s">
							<div class="holder-slider__description-subtitle">Distance</div>
							<div class="holder-slider__description-title">7,065 Miles</div>
						</div>
						<div class="holder-slider__description-item wow fadeInUp" data-wow-offset="250" data-wow-delay="0.4s">
							<div class="holder-slider__description-subtitle">Travel Time</div>
							<div class="holder-slider__description-title">23 Hours<br>5&nbsp;Minutes</div>
						</div>
						<div class="holder-slider__description-item wow fadeInUp" data-wow-offset="250" data-wow-delay="0.2s">
							<div class="holder-slider__description-subtitle">Pricing</div>
							<div class="holder-slider__description-title">$1,976 USD
								<span class="holder-slider__description-title--small">Round Trip</span>
							</div>
						</div>
					</div>
					<div class="holder-slider__btn wow fadeInUp" data-wow-delay="1s">
			...
			<div class="holder-slider__item">
				...
				<div class="holder-slider__info">
					<div class="holder-slider__info-airline" style="background-image: url(img/airline.png);">
						<div class="subtitle">
							<div class="headline-right">
								Airline
							</div>
					...
					<div class="holder-slider__description">
						<div class="holder-slider__description-item">
							<div class="holder-slider__description-subtitle">Destination</div>
							<div class="holder-slider__description-title">Queensland<br>Australia</div>
						</div>
						<div class="holder-slider__description-item">
	...
	<section class="holder sleep section-padding" id="sleep">
		<div class="title wow fadeInLeft" data-wow-offset="250">
			<div class="title__block">
				<span class="wow fadeIn" data-wow-offset="250" data-wow-delay="1s">sleep</span>
				<h3 class="wow fadeInLeft" data-wow-offset="250">sleep</h3>
			</div>
		</div>
		...
		<div class="holder-slider">
			...
			<div class="holder-slider__item">
				...
				<div class="holder-slider__bg" style="background-image: url(img/sleep-slider-bg.png);"></div>

				<div class="holder-slider__info">
					<div class="holder-slider__info-airline wow fadeIn" data-wow-offset="400" data-wow-duration="2s" style="background-image: url(img/hammock.png);">
						<div class="subtitle">
							<div class="headline-right">
								Rating
							</div>
							<div class="subtitle__head">
								Excellent
								<ul class="holder-star travel__holder-star">
									<li class="holder-star__item">
					...
					<div class="holder-slider__description">
						<div class="holder-slider__description-item wow fadeInUp" data-wow-offset="250" data-wow-delay="0.8s">
							<div class="holder-slider__description-subtitle">Resort</div>
							<div class="holder-slider__description-title">Auberge<br>Australia</div>
						</div>
						<div class="holder-slider__description-item wow fadeInUp" data-wow-offset="250" data-wow-delay="0.6s">
							<div class="holder-slider__description-subtitle"># of Nights</div>
							<div class="holder-slider__description-title">
							<div class="quantity">
							  <input class="nights" type="number" min="1" max="10" step="1" value="5" readonly>
							</div>
								Nights
							</div>
						</div>
						<div class="holder-slider__description-item wow fadeInUp" data-wow-offset="250" data-wow-delay="0.4s">
							<div class="holder-slider__description-subtitle"># of Guests</div>
							<div class="holder-slider__description-title">
							<div class="quantity">
							  <input class="guests" type="number" min="1" max="10" step="1" value="4" readonly>
							</div>
								Guests
							</div>
						</div>
						<div class="holder-slider__description-item wow fadeInUp" data-wow-offset="250" data-wow-delay="0.2s">
							<div class="holder-slider__description-subtitle">Pricing</div>
							<div class="holder-slider__description-title">
								<span class="holder-slider__description-title--summ" data-nights="55" data-guests="25"></span> USD
								<span class="holder-slider__description-title--small">Per Night</span>
							</div>
						</div>
					</div>
					<div class="holder-slider__btn wow fadeInUp" data-wow-delay="1s">
			...
			<div class="holder-slider__item">
				...
				<div class="holder-slider__info">
					<div class="holder-slider__info-airline" style="background-image: url(img/hammock.png);">
						<div class="subtitle">
							<div class="headline-right">
								Rating
							</div>
	...
	<section class="shop section-padding" id="shop">
		<div class="title wow fadeInLeft" data-wow-offset="250">
			<div class="title__block">
				<span class="wow fadeIn" data-wow-offset="250" data-wow-delay="1s">shop</span>
				<h3 class="wow fadeInLeft" data-wow-offset="250">shop</h3>
			</div>
		</div>
		<div class="shop-slider">
			<div class="shop-slider__item">
				<div class="shop-slider__inner">
					<div class="shop-slider__info">
						<div class="subtitle">
							<div class="headline-right">Style</div>
							<div class="subtitle__head">North Nugget TT<br>Surfboard</div>
						</div>
						<ul class="holder-star shop__holder-star">
							<li class="holder-star__item">
								<img src="img/svg/star.svg" alt="Star">
							</li>
							<li class="holder-star__item">
						...
						<div class="shop-slider__price">$799<sup>99</sup>
						</div>
						<div class="shop-slider__btn">
							<a href="#" class="btn">Drop <span>in</span></a>
						</div>
					</div>
					<div class="shop-slider__content">
						<div class="shop-slider__surfboard">
							<img src="img/surfboard.png" alt="Surfboard">
							<div class="shop-slider__surfboard-box shop-slider__surfboard-box--position1">
								<div class="shop-slider__surfboard-circles">
									<div class="shop-slider__surfboard-circle"></div>
									<div class="shop-slider__surfboard-circle"></div>
								</div>
								<div class="shop-slider__surfboard-content">
									Double Concave with
									Vee Shape low point
								</div>
							</div>
							<div class="shop-slider__surfboard-box shop-slider__surfboard-box--position2">
								<div class="shop-slider__surfboard-circles">
									<div class="shop-slider__surfboard-circle"></div>
									<div class="shop-slider__surfboard-circle"></div>
								</div>
							...
							<div class="shop-slider__surfboard-box shop-slider__surfboard-box--position3">
								<div class="shop-slider__surfboard-circles">
									<div class="shop-slider__surfboard-circle"></div>
									<div class="shop-slider__surfboard-circle"></div>
								</div>
						...
						<div class="shop-slider__extras">
							Extras
							<div class="shop-slider__extras-items">
								<div class="shop-slider__extras-item">
									<img src="img/wax.png" alt="Wax">
									<div class="shop-slider__extras-title">
										<div class="shop-slider__extras-name">Sex wax</div>
										<div class="shop-slider__extras-price">$24.99</div>
									</div>
								...
								<div class="shop-slider__extras-item">
									...
									<div class="shop-slider__extras-title">
										<div class="shop-slider__extras-name">Pura Vida</div>
										<div class="shop-slider__extras-price">$27.99</div>
									</div>
								</div>
							</div>
						</div>
